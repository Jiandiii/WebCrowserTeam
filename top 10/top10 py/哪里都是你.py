...
filename= 'D:\GitCode\Python\chenff/ages/top10part/age哪里都是你.json'
...
bar.add_yaxis("粉丝数", [0, 150, 38, 8, 1])
...
filename1='D:\GitCode\Python\chenff\locations/top10part/location哪里都是你.json'
