...
filename= 'D:\GitCode\Python\chenff/ages/top10part/age海底.json'
...
bar.add_yaxis("粉丝数", [1, 208, 53, 20, 1])
...
filename1='D:\GitCode\Python\chenff\locations/top10part/location海底.json'
