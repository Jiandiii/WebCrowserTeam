...
filename= 'D:\GitCode\Python\chenff/ages/top10part/age还是会想你.json'
...
bar.add_yaxis("粉丝数", [0, 277, 93, 15, 1])
...
filename1='D:\GitCode\Python\chenff\locations/top10part/location还是会想你.json'
