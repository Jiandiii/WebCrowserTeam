...
filename= 'D:\GitCode\Python\chenff/ages/top10part/ageNew Boy.json'
...
bar.add_yaxis("粉丝数", [1, 72, 146, 22, 0])
...
filename1='D:\GitCode\Python\chenff\locations/top10part/locationNew Boy.json'
