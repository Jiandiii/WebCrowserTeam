...
filename= 'D:\GitCode\Python\chenff/ages/top10part/age晚风.json'
...
bar.add_yaxis("粉丝数", [0, 141, 43, 10, 0])
...
filename1='D:\GitCode\Python\chenff\locations/top10part/location晚风.json'
